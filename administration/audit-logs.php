...
<div class="card">
    <div class="table-responsive">
        <table class="table table-striped align-middle mb-0 small">
                    ...
                    <td class="min-width-260">
                        <?php if (!empty($log['details'])): ?>
                            <details>
                                ...
                                <pre class="small mt-2 mb-0"><?= e(audit_pretty_details($log['details'])) ?></pre>
                            </details>
                        <?php else: ?>
            ...
            <?php endforeach; ?>
            <?php if (!$logs): ?>
                <tr><td colspan="8" class="text-secondary">Audit įrašų nerasta.</td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </div>
