...
('Vartotojų valdymas','users.manage','Vartotojų valdymas')
ON DUPLICATE KEY UPDATE name=VALUES(name);
...
SELECT 2, id FROM permissions WHERE slug IN ('admin.access','settings.manage','themes.manage','navigation.manage','infusions.manage','panels.manage','roles.manage','permissions.manage','users.manage');
